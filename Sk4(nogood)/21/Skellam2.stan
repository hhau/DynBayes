...
transformed parameters {
  ...
  attackGoals[1] <- muAttGoals + stdAtt/(1-phiAttGoal*phiAttGoal) *  (u_att_G_raw[1] * JmatTrans) ;
  attackBehinds[1] <- muAttBehinds + stdAtt/(1-phiAttBehind*phiAttBehind) * u_att_B_raw[1] * JmatTrans;
  defend[1] <- muDef + stdDef/(1-phiDef*phiDef) * u_def_raw[1] * JmatTrans;
